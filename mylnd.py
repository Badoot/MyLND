...
if args.openchannel:
    ...
    if args.openchannel[3]:
        private = args.openchannel[3]
    else:
        private = bool(False)
    output.out_open_channel(node_pubkey, local_funding_amount, push_sat, private)
...
if args.openchannel_wait:
    ...
    if len(args.openchannel_wait) > 3:
        private = args.openchannel_wait[3]
    else:
        private = bool(False)
    output.out_open_channel_wait(node_pubkey, local_funding_amount, push_sat, private=False)
